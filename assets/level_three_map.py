...
def create_map_level_3():    
    enemies = [
        Enemy(-290, 0, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND),
        Enemy(670, 0, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND),
        Enemy(100, 0, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND),
        Enemy(250, 0, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND),
        Enemy(1081, 640, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND),
        Enemy(-580, 640, 50, 50, load_sprite_sheets("Enemies", "PinkMan", 32, 32, True), MUD_PARTICLE_IMG_PATH, DEATH_SOUND)
    ]
