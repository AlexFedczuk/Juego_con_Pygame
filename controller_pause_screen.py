...
from constants import WINDOW, FONT_PATH, WIDTH, PAUSE_BACK_GROUND_IMAGE, HEIGHT
...
def controller_pause_menu():
    ...
    while True:
        ...
        CONTINUE_BUTTON = Button_Text(pygame.image.load(r"assets\Play Rect.png"), WIDTH/2, 225, "CONTINUE", get_font(FONT_PATH, 25), SUPER_LIGHT_GREEN, WHITE)
        EXIT_BUTTON = Button_Text(pygame.image.load(r"assets\Play Rect.png"), WIDTH/2, 650, "EXIT", get_font(FONT_PATH, 25), SUPER_LIGHT_GREEN, WHITE)
